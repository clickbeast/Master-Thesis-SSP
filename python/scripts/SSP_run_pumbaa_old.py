...
class Runner:
    ...
    def create_commands_files(self):
        ...
        with open( self.root_project_path + "data/config/commands.txt",
    ...
    def  run_parallel(self):
        ...
        command = "parallel --jobs 32  --progress < " + self.root_project_path + "/" + "data/config/commands.txt"
        os.system(command)
...
def create_project_root_path():
    return "/home/simonvermeir/Master-Thesis-SSP"
